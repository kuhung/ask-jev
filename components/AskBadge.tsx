...
export const AskBadge: React.FC = () => {
  return (
    <div className="inline-flex flex-col items-start select-none">
      <div className="bg-gradient-to-br from-red-500 via-retroRed-600 to-retroRed-800 border-2 sm:border-[3px] border-cream-50 rounded-[50%/50%] px-4 py-2 sm:px-6 sm:py-3 shadow-brutal-sm sm:shadow-brutal -rotate-6 transform transition-transform hover:rotate-0">
